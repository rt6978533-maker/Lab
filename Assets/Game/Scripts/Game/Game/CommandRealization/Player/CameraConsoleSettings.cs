...
namespace Game.CommandRealization
{
    ...
    public class CameraConsoleSettings : MonoBehaviour
    {
        ...
        public string SetCamFov(float fov = 60) { _camera.fieldOfView = fov; return "CamFov set " + fov; }

        [ConsoleCommand("cam_bg", RequireBinding.Cheats)]
        public string SetCamBG(byte r = 0, byte g = 0, byte b = 0) {
            ...
            return $"CamBG set({resultR} {resultG} {resultB})";
        }
    }
}